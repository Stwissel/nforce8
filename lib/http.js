...
/**
 * If an sobject is provided, resets it (when `_reset` exists) and assigns its id from `body.id`.
 * @param {*} body - The response body that may contain an `id` property.
 * @param {object} [sobject] - The sobject to operate on; if present, `_reset()` will be called when available and `setId(id)` will be called with `body.id` when present.
