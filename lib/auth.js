...
const getAuthUri = function (opts = {}) {
  ...
  for (const field of ['scope', 'prompt']) {
...
/**
 * Notify the onRefresh handler if configured, then resolve with the updated OAuth.
 * Supports both legacy callback-style (arity >= 3) and modern async/promise-returning handlers.
